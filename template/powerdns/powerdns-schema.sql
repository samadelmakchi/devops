...
CREATE INDEX comments_name_type ON comments(name, type);
CREATE INDEX comments_order ON comments(domain_id, modified_at);
...
CREATE UNIQUE INDEX tsigkeys_namealgo ON tsigkeys(name, algorithm);