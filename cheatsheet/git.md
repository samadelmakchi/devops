...
فرض کنید الان ما توی کامیت شماره بیست پروژه هستیم و به هر دلیلی تصمیم گرفتیم که فایل های ریپازیتوری رو برگردونیم به وضعیتی که توی کامیت شماره پانزده داشتن. اگه بریم توی کامیت جدید شماره بیست و یک و کامیت بیست و یک وضعیتی مشابه کامیت پانزده داشته باشه، ما git revert انجام دادیم. اما اگر کامیت های شماره شانزده به بعد رو حذف کنیم و برگردیم به کامیت شماره پانزده، ما git reset انجام دادیم.
