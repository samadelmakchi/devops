...
### فاز 1
- از داکر کامپوز یافتن اطلاعات پایگاه داده ها و استفاده از آنها بجای تعریف در فایل پلی بوک
- ساخت فایل ها و پوشه ها : volumes - test - backup - database - برای هر مشتری یک فایل به اسم مشتری در داخل این پوشه ها
