...
<details>
  ...
  ```bash
  sudo docker compose -f tools/server/haproxy.yml up -d
  ```
</details>
<details>
  <summary>Rancher</summary>
  ...
  ![SQLite](img/sqlite_web.png)

  برای نصب Rancher دستورات زیر را اجرا کنید.
  ```bash
  sudo docker compose -f tools/server/sqlite_web.yml up -d
  ```
</details>
...
<details>
  ...
  برای نصب Rancher دستورات زیر را اجرا کنید.
  ```bash
  sudo docker compose -f tools/dev/sqlite_web.yml up -d
  ```
</details>
